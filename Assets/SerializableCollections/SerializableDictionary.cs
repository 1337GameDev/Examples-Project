...
{
    //<summary>
    // SerializableDictionary(SerializableCollections) is fast, 
    // native serializable collections for Unity, includes SerializableDictionary, 
    // SerializableLookup, SerializableTuple.
    // <para>
    // Open-source; fetched from: https://github.com/neuecc/SerializableDictionary
    // </para>
    //</summary>
    [Serializable]
    public class SerializableDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary
    {
        ...
        public  SerializableDictionary(int initialCapacity)
        {
            Initialize(initialCapacity);
        }

        public SerializableDictionary(int staticCapacity, bool forceSize)
        {
